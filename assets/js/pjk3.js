...
$(document).on('click','.item-invoices',function(e) {
    ...
    $.ajax({
        type: 'POST',
        data: formData,
        url: admin_url + 'pjk3/create_product_and_services',
        ...
        console.log(response);
           response = JSON.parse(response);
            if (response.success) {
                ...
                //location.href = admin_url+'pjk3/client/16'+'?tab=product_services';
    ...
    var url;
        ...
        if (typeof (id) !== 'undefined') {
            ...
            if($('#item_site_url').val() == 1 ){
                url = site_url+'pjk3/product_services/edit/' + id;
            }else if($('#item_site_url').val() == 'undefined'){
                url = admin_url+'pjk3/edit/' + id;
            }else{
                 url = admin_url+'pjk3/edit/' + id;
            }
