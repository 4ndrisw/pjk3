  ...
  <table class="table dt-table invoice-items" data-order-col="3" data-order-type="desc">
   ...
   <tr>
      ...
      <td>
         ...
         <div class="row-options"><a href="#" data-toggle="modal" data-target="#sales_item_modals" data-id="<?php echo $item['itemid']?>">Edit </a> | <a href="<?php echo site_url();?>pjk3/product_services/delete/<?php echo $item['itemid']?>" class="text-danger _delete">Delete </a></div>
      </td>
