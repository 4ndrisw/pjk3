...
<div class="modal fade" id="sales_item_modals" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open('pjk3/product_services/items_create',array('id'=>'invoice_item_form')); ?>
...
<script type="text/javascript" src="<?php echo base_url();?>modules/pjk3/assets/js/pjk3.js"></script><script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/jquery.form/4.2.2/jquery.form.min.j"></script>
<script>
...
function init_item_js() {
    ...
    $("body").on('show.bs.modal', '#sales_item_modal', function (event) {
        ...
        if (typeof (id) !== 'undefined') {
            $('#invoice_item_form').attr('action', '<?php echo base_url()?>pjk3/product_services/items_create/'+id);
