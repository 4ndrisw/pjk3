...
<div id="wrapper">
  <div class="content accounting-template peralatan">
    <div class="row">
      ...
      $rel_type = '';
      $rel_id = '';
      if (isset($peralatan) || ($this->input->get('rel_id') && $this->input->get('rel_type'))) {
        if ($this->input->get('rel_id')) {
          $rel_id = $this->input->get('rel_id');
          $rel_type = $this->input->get('rel_type');
        } else {
          $rel_id = $peralatan->rel_id;
...
<script>
  ...
  $(function() {
    ...
    peralatan_rel_id_select();
    <?php if (!isset($peralatan) && $rel_id != '') { ?>
      _rel_id.change();
    <?php } ?>
  });

  function peralatan_rel_id_select() {
    var serverData = {};
