        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">
                    <span class="edit-title"><?php echo _l('pjk3_group_edit_heading'); ?></span>
                    <span class="add-title"><?php echo _l('pjk3_group_add_heading'); ?></span>
                </h4>
            </div>
            <?php echo form_open('pjk3/group',array('id'=>'customer-group-modal')); ?>
