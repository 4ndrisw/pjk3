...
<br />
<small class="text-info"><?php echo _l('pjk3_files_info_message'); ?></small>
</h4>
<hr />
<?php if(isset($client)){ ?>
            ...
            <table class="table dt-table scroll-responsive" data-order-col="2" data-order-type="desc">
                <thead>
                    <tr>
                        ...
                        <th><?php echo _l('pjk3_attachments_show_in_customers_area'); ?></th>
                ...
                <tbody>
                    <?php foreach($attachments as $type => $attachment){
                        ...
                        <?php foreach($attachment as $_att){
                         ...
                         <td>
                            <div class="onoffswitch"<?php if($type != 'customer'){?> data-toggle="tooltip" data-title="<?php echo _l('pjk3_attachments_show_notice'); ?>" <?php } ?>>
