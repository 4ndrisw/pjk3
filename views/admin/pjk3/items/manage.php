...
<div role="tabpanel" class="tab-pane" id="product_services">
              ...
              <table class="table dt-table invoice-items"  data-order-type="desc">
               ...
               <tr>
                  ...
                  <td>
                     ...
                     <div class="row-options"><a href="#" data-toggle="modal" data-target="#sales_item_modals" data-id="<?php echo $item['itemid']?>">Edit </a> | <a href="<?php echo admin_url();?>pjk3/delete_item/<?php echo $item['itemid']?>/<?php echo $client->userid?>" class="text-danger _delete">Delete </a></div>
                  </td>
         ...
         <?php $CI->load->view(MODULE_PJK3 . '/admin/pjk3/items/items'); ?>
